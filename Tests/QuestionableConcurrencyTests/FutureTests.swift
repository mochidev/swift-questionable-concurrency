...
@Suite struct FutureTests {
    ...
    @Test func testInstantThrowingFulfillment() async throws {
        ...
        #expect(asyncResult as Any is Future<(), any Error>)
    ...
    @Test func testInstantTypedThrowingFulfillment() async throws {
        let asyncResult = Future { () throws(TestError) -> Never in
            throw TestError()
        }
        #expect(asyncResult as Any is Future<Never, TestError>)
        #expect(await asyncResult.result == .failure(TestError()))
    }
    
    @Test func testInstantSuccess() async throws {
        let asyncResult = Future { 0 }
        #expect(await asyncResult.value == 0)
    }
    
    @Test func testInstantThrowingSuccess() async throws {
        let asyncResult = Future<_, TestError> { 0 }
        #expect(try await asyncResult.value == 0)
    }
    
    @Test func testInstantResult() async throws {
        let asyncResult = Future<_, Never> { .success(0) }
        #expect(await asyncResult.result == .success(0))
    }
    
    @Test func testInstantCasts() async throws {
        do {
            let asyncResult = Future(Result<Int, TestError>.success(0))
            #expect(asyncResult as Any is Future<Int, TestError>)
            #expect(await asyncResult.result == .success(0))
        }
        do {
            let asyncResult = Future(Result<Int, TestError>.failure(TestError()))
            #expect(asyncResult as Any is Future<Int, TestError>)
            #expect(await asyncResult.result == .failure(TestError()))
        }
        do {
            let asyncResult = Future<Int, TestError>.success(0)
            #expect(asyncResult as Any is Future<Int, TestError>)
            #expect(await asyncResult.result == .success(0))
        }
        do {
            let asyncResult = Future<Int, TestError>.failure(TestError())
            #expect(asyncResult as Any is Future<Int, TestError>)
            #expect(await asyncResult.result == .failure(TestError()))
        }
        do {
            let asyncResult = Future.success(0)
            #expect(asyncResult as Any is Future<Int, Never>)
            #expect(await asyncResult.result == .success(0))
        }
        do {
            let asyncResult = Future.failure(TestError())
            #expect(asyncResult as Any is Future<Never, TestError>)
            #expect(await asyncResult.result == .failure(TestError()))
        }
    }
    ...
    @Test func testDelayedThrowingSuccess() async throws {
        let asyncResult = Future<_, TestError> {
            try? await Task.sleep(for: .seconds(0.0001))
            return 0
        }
        #expect(try await asyncResult.value == 0)
    ...
    @Test func testDelayedResult() async throws {
        let asyncResult = Future<_, Never> {
            try? await Task.sleep(for: .seconds(0.0001))
            return .success(0)
        }
        #expect(await asyncResult.result == .success(0))
    ...
    @Test func testCachedTypedThrowingFulfillment() async throws {
        let asyncResult = Future.cached { () throws(TestError) -> Never in
            try? await Task.sleep(for: .seconds(0.0001))
            throw TestError()
        }
        #expect(await asyncResult.result == .failure(TestError()))
    ...
    @Test func testCachedThrowingSuccess() async throws {
        let asyncResult = Future<_, TestError>.cached {
            try? await Task.sleep(for: .seconds(0.0001))
            return 0
        }
        #expect(try await asyncResult.value == 0)
    ...
    @Test func testCachedResult() async throws {
        let asyncResult = Future<_, Never>.cached {
            try? await Task.sleep(for: .seconds(0.0001))
            return .success(0)
        }
        #expect(await asyncResult.result == .success(0))
    ...
    @Test func testMappingSuccess() async throws {
        let successfulResult = Future { 0 }.map { success in
            try? await Task.sleep(for: .seconds(0.0001))
            return success + 1
        }
        #expect(await successfulResult.value == 1)
        
        let failingResult = Future<Int, _> {
            throw TestError()
        }.map { success in
    ...
    @Test func testFlatMappingSuccess() async throws {
        let successfulResult = Future { 0 }.flatMap { success in
            try? await Task.sleep(for: .seconds(0.0001))
    ...
    @Test func testMappingResult() async throws {
        let successfulResult = Future { 0 }.mapResult { result in
            try? await Task.sleep(for: .seconds(0.0001))
            switch result {
    ...
    @Test func testMappingError() async throws {
        let successfulResult = Future<_, TestError> { 0 }.mapError { error in
            Issue.record("Should not actually be called.")
            return TestError()
        }
    ...
    @Test func testFlatMappingError() async throws {
        let successfulResult = Future<_, TestError> { 0 }.flatMapError { error in
            Issue.record("Should not actually be called.")
